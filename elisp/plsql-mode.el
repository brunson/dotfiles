...
(if plsql-mode-syntax-table
  ...
  (modify-syntax-entry ?-  ". 12"  plsql-mode-syntax-table) ;-- starts comment to eol
  (modify-syntax-entry ?\n ">   "  plsql-mode-syntax-table) ;LFD ends comment
  (modify-syntax-entry ?\^m ">   " plsql-mode-syntax-table) ;RET ends comment

...
;; Copyright (C) 1997 Free Software Foundation, Inc., Jim Lange, Karel Sprenger.

;; Author: Jim Lange, Oracle Corporation <jlange@us.oracle.com>
;;	Karel Sprenger, University of Amsterdam <ks@ic.uva.nl>
;; Maintainer: Karel Sprenger <ks@ic.uva.nl>
;; Created: 27-MAR-90
;; Version: $Id: sql-mode.el,v 1.7 1998/06/03 09:27:42 ks Exp $
;; Keywords: Oracle, SQL, SQL*Plus
...
;;  $Log: sql-mode.el,v $
;;  Revision 1.7  1998/06/03 09:27:42  ks
;;  Added change log comments for revisions 1.5 through 1.2.
;;
;;  Revision 1.6  1998/06/03 08:46:05  ks
;;  Fixed font-lock stuff to properly handle comments;
;;  Changed header and other comments to GNU emacs 'standards'.
;;
;;  Revision 1.5  1997/11/27 12:49:07  ks
;;  ignore '--' style comments in sql-mode-syntax-table;
;;  regexp for '--' style comments in sql-font-lock-keywords fixed;
;;  font-lock-defaults adjusted for use in Emacs 19.29 and later.
;;
;;  Revision 1.4  1997/11/26 21:54:30  ks
;;  use eval-when-compile to load make-regexp and
;;  to define the regexps used for sql-font-lock-keywords.
;;
;;  Revision 1.3  1997/11/26 12:09:23  ks
;;  Use make-regexp to get better regexps for font-lock;
;;  Adjust syntax table and take care to properly fontify
;;  comments.
;;
;;  Revision 1.2  1990/04/10 07:11:42 jlange
;;  checked in with -k by ks at 1997/11/26 08:29:45
;;
...
(defvar sql-mode-convert-defines nil
  "Non-nil if you wish to convert ':' to '&'.")

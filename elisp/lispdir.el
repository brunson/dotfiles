...
(defvar lisp-code-directory
 "/anonymous@ftp.cis.ohio-state.edu:pub/emacs-lisp/LCD-datafile.gz"
...
(defvar elisp-archive-host "ftp.cis.ohio-state.edu"
  "*Site with elisp archive available via anonymous ftp.")

(defvar elisp-archive-directory "/pub/emacs-lisp/"

...
alias dfg='df -h'
alias duh='du -sh *'
alias sduh='du -sh * | sort -h'
alias resilver_mon="while true ; do tput clear ; date ; uptime ; echo ; cat /proc/mdstat ; grep -q _UUU /proc/mdstat || break ; sleep 60 ; done"
alias mdstat="cat /proc/mdstat"
alias biggest="du -sh * | sort -h"
alias vncpapa="open vnc://papa.lan:5901"
alias okssh="ssh -l opc -i ~/.ssh/oci-k8s-dev"
alias akssh="ssh -l ec2-user -i ~/.ssh/eks-infraplat-security-202004.pem"
alias akdssh="ssh -l ec2-user -i ~/.ssh/eks-infraplat-security-202004-dev.pem"
...
alias counts="my inv -t -e 'select * from count_by_state where state = \"running\" and created = (select min(created) from count_by_state) order by environment;'"
...
alias odcgroupsearch='ldapsearch -h aps-dc01.oracledatacloud.com. -D "odc\\svc.core.ldap" -E pr=1000/noprompt -x -b "ou=User Groups,dc=oracledatacloud,dc=com" -o ldif-wrap=no -w $(cat ~/.odcldap)'
